...
<AccordionGroup>
  ...
  <Accordion title="VoyageAI by MongoDB">
    ...
    **Config Options:**
    ...
    - `model` (str): Model to use. Default: `voyage-3.5`. Current models: general-purpose `voyage-4-large`, `voyage-4`, `voyage-4-lite`, `voyage-3.5`, `voyage-3.5-lite`; code `voyage-code-4`, `voyage-code-3`; finance `voyage-finance-2`; law `voyage-law-2`; contextualized `voyage-context-4`. See https://docs.voyageai.com/docs/embeddings for the full catalog.
    ...
    **Contextualized models:** Set `model` to a contextualized model such as `voyage-context-4` and CrewAI automatically routes requests through the [contextualized chunk embeddings](https://docs.voyageai.com/docs/contextualized-chunk-embeddings) endpoint, so each chunk is embedded with awareness of its surrounding chunks.
  </Accordion>
